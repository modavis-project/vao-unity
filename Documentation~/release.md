...
This repository is prepared as release candidate `0.6.0-rc.1`. Preparation does not authorize changing repository visibility, pushing commits or tags, creating a GitHub Release, or publishing the reserved Zenodo record.
...
1. Push the reviewed commit while the GitHub repository remains private and confirm CI passes from a clean runner.
